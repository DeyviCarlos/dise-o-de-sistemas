...
public class Vista_EditarUbicacion extends javax.swing.JFrame {
    ...
    Calendar c;
    public Vista_EditarUbicacion(Ubicacion ubi) {
        initComponents();
        this.ubiBO = new UbicacionBO();
        this.arrUbicacion = new ArrayList<>();
        codigo = ubi.getIdUbicacion();
        c=Calendar.getInstance();
        c.setTime(new Date());
        jdateFecha.setCalendar(c);
        
        
        txtBloque.setText(ubi.getBloque());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(76, 34, 200, 23));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        ubicacion = new Ubicacion(codigo,nombre, (java.sql.Date) date);

        if(ubiBO.modificarrUbicacion(ubicacion)){
            ModalListo mod = new ModalListo(this,true,"Ubicación Editada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_EditarUbicacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
