...
public class Vista_RegistroTipoUsuario extends javax.swing.JFrame {
    ...
    public Vista_RegistroTipoUsuario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(350, 525));
        ...
        jLabel1.setText("NUEVO TIPO USUARIO");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 240, 23));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        tip = new Tipo_usuario(nombre);
        //modificar su condicion
        if(tp_userbo.agregarTipoUsuario(tip)){
            ModalListo mod = new ModalListo(this,true,"Tipo de Usuario Registrado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_RegistroTipoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_RegistroTipoUsuario().setVisible(true);
            }
        });
    }
