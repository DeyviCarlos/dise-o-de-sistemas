...
public class Vista_CrearProveedor extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        prov = new Proveedor(razon, ruc, dir, telf);
        //****************modificar la condicion***********************
        boolean condicion = true;
        if(this.provBO.registrarProveedor(prov)){
        //if(userbo.registrarUsuario(usuario)){
            ModalListo mod = new ModalListo(this,true,"Proveedor Registrado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_CrearProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_CrearProveedor().setVisible(true);
            }
        });
    }
